...
def submitJobs():
    ...
    #submit job
    os.system("cp /afs/cern.ch/user/m/msommerh/CMSSW_10_3_3/src/NanoTreeProducer/combine_run2{}.sh ./combine_{}_{}{}.sh".format("_single" if args.category!="" else "", args.year, args.btagging, "_"+args.category if args.category != "" else ""))
