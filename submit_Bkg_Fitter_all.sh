...
./submit_Bkg_Fitter.py -MC -q tomorrow -y run2 -b semimedium
...
#./submit_Bkg_Fitter.py -MC -q tomorrow -y 2018 -b semimedium
...
#./submit_Bkg_Fitter.py -MC -q tomorrow -y 2017 -b semimedium
...
#./submit_Bkg_Fitter.py -MC -q tomorrow -y 2016 -b semimedium
