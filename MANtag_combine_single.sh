...
if [[ $combined -eq 1 ]]; then
    cp ${main_dir}datacards/MANtag_study/${btagging}/${category}_combined_run2_M${mass}${suffix} datacards/MANtag_study/${btagging}/
    ...
    cp ${main_dir}datacards/MANtag_study/${btagging}/${category}_${year}_M${mass}${suffix} datacards/MANtag_study/${btagging}/
...
echo "ls datacards/MANtag_study/${btagging}/"
ls datacards/MANtag_study/${btagging}/
echo "ls workspace/MANtag_study/${btagging}/"
ls workspace/MANtag_study/${btagging}/

if [[ $combined -eq 1 ]]; then
    inputfile=datacards/MANtag_study/${btagging}/${category}_combined_run2_M${mass}${suffix}
    outputfile="${main_dir}combine/limits/MANtag_study/${btagging}/single_category/combined_run2/"
    tempfile=$(echo $inputfile | sed s:${main_dir}datacards/MANtag_study/${btagging}/${category}_combined:${workdir}/${category}:g)
else
    inputfile=datacards/MANtag_study/${btagging}/${category}_${year}_M${mass}${suffix}
    outputfile="${main_dir}combine/limits/MANtag_study/${btagging}/single_category/"
    tempfile=$(echo $inputfile | sed s:${main_dir}datacards/MANtag_study/${btagging}/:${workdir}/:g)
fi
