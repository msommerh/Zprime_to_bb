...
variable = {
    ...
    'jj_mass_widejet': {
        ...
        'min' : 1530.,
        'max' : 9067.,
        'bins': [1530, 1607, 1687, 1770, 1856, 1945, 2037, 2132, 2231, 2332, 2438, 2546, 2659, 2775, 2895, 3019, 3147, 3279, 3416, 3558, 3704, 3854, 4010, 4171, 4337, 4509, 4686, 4869, 5058, 5253, 5455, 5663, 5877, 6099, 6328, 6564, 6808, 7060, 7320, 7589, 7866, 8152, 8447, 8752, 9067], 
        'log' : True,
    },
    'jj_deltaEta_widejet': {
        'title' : "#Delta #eta_{jj}",
