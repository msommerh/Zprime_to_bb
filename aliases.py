...
alias = { ## the same as above with the new btag_WP variable
    ...
    "2mu": preselection+triggers+AK8veto+electronVeto+muonVeto+" && jbtag_WP_1<{WP} && jbtag_WP_2<{WP} && jnmuons_1>0 && jnmuons_2>0"
}
...
aliasSM = { ## a new btagging category that is semi medium, semi loose.
    ...
    "2mu": preselection+triggers+AK8veto+electronVeto+muonVeto+" && jbtag_WP_1<2 && jbtag_WP_2<2 && jnmuons_1>0 && jnmuons_2>0"
}
