...
archiveTagsDATA = {'2016' : 'Summer16_07Aug2017_V11_DATA', 
                   ...
                   '2017' : 'Fall17_17Nov2017_V6_DATA',  
                   #'2017' : 'Fall17_17Nov2017_V7_DATA',  
...
jecTagsDATA = { '2016B' : 'Summer16_07Aug2017BCD_V11_DATA', 
                ...
                '2017B' : 'Fall17_17Nov2017B_V6_DATA', 
                ...
                #'2017B' : 'Fall17_17Nov2017B_V7_DATA', 
                #'2017C' : 'Fall17_17Nov2017C_V7_DATA', 
                #'2017D' : 'Fall17_17Nov2017D_V7_DATA', 
                #'2017E' : 'Fall17_17Nov2017E_V7_DATA', 
                #'2017F' : 'Fall17_17Nov2017F_V7_DATA', 
...
def createJMECorrector(isMC=True, dataYear=2016, runPeriod="B", jesUncert="Total", redojec=False, jetType = "AK4PFchs", noGroom=False):
    ...
    if isMC:
        ...
        jmeCorrections = lambda : jetRecalib(globalTag=jecTag_, archive=archiveTagsDATA[dataYear], jetType=jetType, redoJEC=redojec)
